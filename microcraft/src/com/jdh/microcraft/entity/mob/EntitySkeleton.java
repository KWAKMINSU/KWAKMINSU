...
public class EntitySkeleton extends EntityHumanoid {
    private static final Item[] LOOT_TABLE = {
        Gem_Item.GEM, Gold_Item.GOLD_INGOT,
        Item.COAL, Item.COAL, Iron_Item.IRON_INGOT, Iron_Item.IRON_INGOT,
        Item.COAL, Item.COAL, Iron_Item.IRON_ORE, Iron_Item.IRON_ORE, Iron_Item.IRON_ORE,
        Item.GLASS, Item.GLASS, Item.GLASS, Item.PIE, Iron_Item.IRON_ORE,
        Rock_Item.ROCK, Rock_Item.ROCK, Rock_Item.ROCK, Rock_Item.ROCK, Item.SAND, Item.SAND, Item.SAND
    };
