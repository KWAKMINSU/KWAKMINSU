...
public class EntityZombie extends EntityHumanoid {
    private static final Item[] LOOT_TABLE = {
        Gem_Item.GEM, Gold_Item.GOLD_INGOT, Mithril_Item.MITHRIL_INGOT,
        Iron_Item.IRON_INGOT, Iron_Item.IRON_INGOT, Iron_Item.IRON_INGOT, Iron_Item.IRON_INGOT,
        Iron_Item.IRON_ORE, Iron_Item.IRON_ORE, Iron_Item.IRON_ORE, Iron_Item.IRON_ORE, Iron_Item.IRON_ORE,
        Iron_Item.IRON_ORE, Iron_Item.IRON_ORE, Iron_Item.IRON_ORE, Iron_Item.IRON_ORE, Iron_Item.IRON_ORE,
        Rock_Item.ROCK, Rock_Item.ROCK, Rock_Item.ROCK, Rock_Item.ROCK, Rock_Item.ROCK, Rock_Item.ROCK, Rock_Item.ROCK
    };
