...
public abstract class EntityHumanoid extends EntityMob {
    ...
    public static void giveRandomEquipment(EntityHumanoid entity, int level, boolean armor, boolean weapon) {
        ...
        Item[][] armorTable = new Item[][]{
            {Iron_Item.IRON_HELMET, Iron_Item.IRON_CHESTPLATE, Iron_Item.IRON_LEGGINGS, Iron_Item.IRON_BOOTS},
            {Gold_Item.GOLD_HELMET, Gold_Item.GOLD_CHESTPLATE, Gold_Item.GOLD_LEGGINGS, Gold_Item.GOLD_BOOTS},
            {Gold_Item.GOLD_HELMET, Gold_Item.GOLD_CHESTPLATE, Gold_Item.GOLD_LEGGINGS, Gold_Item.GOLD_BOOTS}
        };

        Item[][] weaponTable = new Item[][]{
            {Rock_Item.ROCK_SWORD, Rock_Item.ROCK_AXE},
            {Iron_Item.IRON_SWORD, Iron_Item.IRON_AXE},
            {Gold_Item.GOLD_SWORD, Gem_Item.GEM_SWORD, Mithril_Item.MITHRIL_SWORD}
        };
