...
public abstract class Tile {
    ...
    public static final TileOre IRON_ORE = new TileOre(17, 200, Iron_Item.IRON_ORE);
    public static final TileOre GOLD_ORE = new TileOre(18, 300, Gold_Item.GOLD_ORE);
    public static final TileOre GEM_ORE = new TileOre(19, 300, Gem_Item.GEM);
    public static final TileOre MITHRIL_ORE = new TileOre(20, 500, Mithril_Item.MITHRIL_ORE);
